...
<?php
    ...
    $sql = "SELECT sum(zarobki) as suma_zarobkow, dzial, nazwa_dzial FROM pracownicy, organizacja WHERE id_org = dzial GROUP BY dzial";
...
/*
    ...
    $sql = "SELECT avg(zarobki) as avg_zarobki, dzial, nazwa_dzial FROM pracownicy, organizacja WHERE id_org = dzial GROUP BY dzial";
